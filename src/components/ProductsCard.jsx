...
function ProductsCard({ product }) {
  const { addToCart } = useCart();  // Use the hook to access addToCart

  const handleAddToCart = () => {
    addToCart(product);  // Call addToCart function from context
  };
      ...
      >
        ...
        <div className="p-4 sm:p-6 flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-100 mt-auto">
            ...
            <button
              onClick={handleAddToCart}  // Make sure this calls the correct function
